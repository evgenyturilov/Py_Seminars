# Задача 33. Задана натуральная степень k. Сформировать случайным образом список коэффициентов (значения от 0 до 100) многочлена и записать в файл многочлен степени k.
...
print(result)
with open(r'D:\GB_Developer\1.6 Знакомство с Python\Python\Py_Seminars\03_Seminar_5&6_tasks_32-44\02_Task_33_file.txt', 'w') as file:
    file.write(result)