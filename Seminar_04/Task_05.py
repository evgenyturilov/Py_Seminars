...
with open(r'D:\GB_Developer\1.6 Знакомство с Python\Python\Py_Seminars\Seminar_04\file_1_to_Task_05.txt', 'r') as file_1:
    polynome_1 = file_1.read()
with open(r'D:\GB_Developer\1.6 Знакомство с Python\Python\Py_Seminars\Seminar_04\file_2_to_Task_05.txt', 'r') as file_2:
...
with open(r'D:\GB_Developer\1.6 Знакомство с Python\Python\Py_Seminars\Seminar_04\file_3_to_Task_05.txt', 'w') as file_3:
